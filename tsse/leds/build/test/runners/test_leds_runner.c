...
int main(void)
{
  ...
  run_test(test_prender_led_individual, "test_prender_led_individual", 30);
  run_test(test_apagar_led_individual, "test_apagar_led_individual", 35);
  run_test(test_prender_led_invalido, "test_prender_led_invalido", 42);
